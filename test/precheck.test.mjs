...
test("factor candidate and runtime thread files are covered by provider-call guard", async () => {
  ...
  await fs.writeFile(
    path.join(libDir, "runtime-thread.mjs"),
  ...
  assert.deepEqual(
    ...
    [
      ...
      "scripts/lib/runtime-thread.mjs:provider_sdk_import"
    ]
  );
});
