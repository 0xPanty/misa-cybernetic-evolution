...
} from "../scripts/lib/l3-real-l2-semantic-pressure.mjs";
...
function passingDraft(sourceId = "swe-rebench-openhands:fixture__real-l2-001") {
  return {
    ...
    concrete_tasks: [
      `In scripts/lib/external-trajectory-online-shadow-contract.mjs, trace source_id=${sourceId} and preserve evidence_refs=fixture__real-l2-001, swe-rebench-openhands-keyword-risk-noise-requires-filter-fixture, swe-rebench-openhands/sanitized-trajectories.fixture.jsonl without adding new refs.`,
      "In test/external-trajectory-online-shadow-contract.test.mjs, check signal=coding_replay_trajectory and route_hint=damping; expected result is hint_only/suggestion_only with no route or winner change.",
      `In scripts/lib/external-trajectory-online-shadow-contract.mjs, confirm ${sourceId}, damping_or_failure_pressure, damping stay observe-only and do not request memory, Zilliz, embedding, VPS, GitHub, or public publish effects.`,
