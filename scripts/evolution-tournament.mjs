...
if (asJson) {
  ...
  console.log(`metric_gaming_risk: ${result.tournament_ranking.restraint_contract.metric_gaming_risk.level} (${result.tournament_ranking.restraint_contract.metric_gaming_risk.score})`);
