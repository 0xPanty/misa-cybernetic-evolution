...
if (hasArg("json")) {
  ...
  console.log(`primary_agent_inline_review=${result.summary.primary_agent_inline_review_count}`);
  console.log(`separate_llm_call_required=${result.summary.separate_llm_call_required_count}`);
