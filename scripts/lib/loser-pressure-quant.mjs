...
import {
  DEFAULT_GENERATED_FILL_WEIGHTS,
  DEFAULT_OLLAMA_BASE_URL,
  DEFAULT_OLLAMA_MODEL,
  allocateGeneratedFill,
  buildGeneratedSamples,
  loadBaseSamples,
  normalizeFillWeights
} from "./loser-pressure-samples.mjs";
...
const MATRIX_SCENARIOS = Object.freeze([
  {
    ...
    memory_decay: 0.995,
    generated_fill_weights: DEFAULT_GENERATED_FILL_WEIGHTS
  },
  {
...
export async function runLoserPressureQuant({
  ...
  generatedFillWeights = DEFAULT_GENERATED_FILL_WEIGHTS,
