...
function componentSummaries(calibration, smoke, components) {
  ...
  return {
    ...
    hermes_runtime_adapter: {
      ...
      official_evolution_candidates: hermesRuntimeAdapterCheck?.official_evolution_candidates ?? 0,
      inferred_evolution_pressure: hermesRuntimeAdapterCheck?.inferred_evolution_pressure ?? 0,
      boundary_observations: hermesRuntimeAdapterCheck?.boundary_observations ?? 0,
      observability_stream: hermesRuntimeAdapterCheck?.observability_stream ?? 0,
      work_order_stream: hermesRuntimeAdapterCheck?.work_order_stream ?? 0,
      sidecar_signal_to_noise_ratio: hermesRuntimeAdapterCheck?.sidecar_signal_to_noise_ratio ?? null,
